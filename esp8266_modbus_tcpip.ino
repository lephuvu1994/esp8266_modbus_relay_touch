...
void setup() {
 ...
 attachInterrupt(digitalPinToInterrupt(12), battatcung, CHANGE);
...
///// code here --- codigo aqui
 ...
 /// Enable Output 14
 if( MBHoldingRegister[1] !=bitstatus1)// || digitalRead(12) != bitstatus2)
 {
    digitalWrite(14, !digitalRead(14));
    Serial.println(digitalRead(12));
    if(MBHoldingRegister[1] !=bitstatus1){
      
      bitstatus1 =  digitalRead(14);
      MBHoldingRegister[1] = bitstatus1;
      
    }
//    else if(digitalRead(12) != bitstatus2){
//      bitstatus2 =   digitalRead(12);
//      bitstatus1 = digitalRead(14);
//      MBHoldingRegister[1] =  bitstatus1;
//    }
 }
// digitalWrite(14, MBHoldingRegister[1] );
...
void ICACHE_RAM_ATTR  battatcung(void)
{
//      Serial.println(digitalRead(12));
      digitalWrite(14, !digitalRead(14));
      bitstatus2 =   digitalRead(12);
